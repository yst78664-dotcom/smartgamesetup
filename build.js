...
<head>
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .topic-card h3 { color:#f1f5f9; font-size:20px; margin-bottom:6px; }
    .topic-card p { color:#64748b; font-size:14px; margin:0; }
  ...
  <div class="gallery-wrap">
    <div class="gallery-carousel">
      <div class="gallery-track" id="galleryTrack">
        ...
        <div class="gallery-slide"><img src="/images/gallery-setup-6.jpg" alt="Mint green Nanoleaf gaming setup" loading="lazy"><div class="gallery-caption"><h3>💚 Cyberpunk Pod</h3><p>Compact multi-monitor nook with Nanoleaf hex panels and sci-fi vibes</p></div></div>
        <div class="gallery-slide"><img src="/images/gallery-setup-7.jpg" alt="Cyan green futuristic gaming desk" loading="lazy"><div class="gallery-caption"><h3>🌿 Futuristic Green</h3><p>Mint-cyan gaming nook with geometric wall art and glass PC build</p></div></div>
